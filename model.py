# this file implements our utilized U-Net-like architecture
...
# a class defining a convolution block comprising two conv-InstanceNorm-LeakyRelu-blocks
...
# same convolution block without the use of padding
...
# same convolution modul however using kernel_sizes of 5 to increase the receptive field
